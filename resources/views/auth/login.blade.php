                    ...
                    <div>
                        <form action="{{ route('login') }}" method="post">
                            ...
                            <div class="space-y-5">
                                ...
                                @error('email')
                                <div>
                                    <p class="text-sm text-orange-500 dark:text-orange-400">{{ $message }}</p>
                                </div>
                                @enderror
                            </div>
                        </form>
            ...
            <div class="flex items-center justify-center z-1">
                ...
                >
                    <img
                        src="{{
                            asset(
                                'tailadmin/build/src/images/shape/grid-01.svg'
                            )
                        }}"
                        alt="grid"
                    />
                ...
                <div class="flex flex-col items-center max-w-xs">
                    <a href="index.html" class="block mb-4">
                        <img
                            src="{{
                                asset(
                                    'tailadmin/build/src/images/logo/auth-logo.svg'
                                )
                            }}"
                            alt="Logo"
                        />
